...
<div class="row mt-3">
    ...
    <div class="col-md-4">
        {% include figure.html path="assets/img/osprey.jpg" title="Osprey" class="img-fluid rounded z-depth-1" %}
        <div class="caption text-center mt-2">Osprey</div>
    </div>
    <div class="col-md-4">
        {% include figure.html path="assets/img/magnolia_warbler.jpg" title="Magnolia Warbler" class="img-fluid rounded z-depth-1" %}
        <div class="caption text-center mt-2">Magnolia Warbler</div>
    </div>
</div>
